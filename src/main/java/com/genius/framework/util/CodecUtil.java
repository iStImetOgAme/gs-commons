package com.genius.framework.util;
...
public class CodecUtil {
     ...
     */
    public static String desEncrypt(String str, boolean urlSafety) {
        if (null != str) {
            try {
     ...
     * @return 加密后的密文(base64编码字符串,Url安全)
     */
    public static String desEncryptUrl(String str, String key) {
        return desEncrypt(str, key, true);
    }
    ...
    public static void main(String[] args) {
        String token = "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJhY2NvdW50X2lkIjoiMTIzIiwiZW50aXR5X25hbWUiOiLnrqHnkIblkZgiLCJ1c2VyX25hbWUiOiJhZG1pbiIsImFjY291bnRfbmFtZSI6ImFkbWluIiwidGhzX3RlbmFudCI6ImRlZmF1bHQiLCJlbnRpdHlfaWQiOiIxMjMiLCJleHAiOjE1OTc3MTc1MjA3ODQsImlhdCI6MTU5NzYzMTEyMH0.gOwiEIYbfBpnocyJNVeoMMrSAUB8igYgva2y_bKndeaMiAdv5AcT856wL1wAjS8X9zMNrsVsZvrGKMLe7K-tDMgMtPHUwNgPTNIWclnZx0LghNiiC5O412zXL0VDrJFTB5jeuNteHhpA29nepychOHwUltnlFyWFsH6sl_zI72MewMFDn-QIuFW3W5J7_dr-obPzFoPaoVzD-LW-vYU2ehkYXUMwPUN1jf8udg0YLNStwugp98NeY1aF3VNFeeBE-kEh3iRrRvCVXV8a2rL24ZAP9tGKw0cIaD1nWNZG6ggkBH13qEXw1zW0PD8P6KbVe0tEODmbSdx5rdN1wICMdQ";
        DateTimeFormatter dateTimeFormatter = DateTimeFormatter.ofPattern("yyyyMMddHHmmssSSS");
        LocalDateTime nowTime = LocalDateTime.now();
        String key = nowTime.format(dateTimeFormatter);
        System.out.println("key=> " + key);
        /** AES */
        String aesToken = aesEncrypt(token, key);
        System.out.println("aesToken=> " + aesToken);

        String aesTokenMd5 = md5(aesToken);
        System.out.println("aesTokenMd5=> " + aesTokenMd5);
 
        System.err.println("desDecrypt aesToken=> " + aesDecrypt(aesToken, key));
    }
}